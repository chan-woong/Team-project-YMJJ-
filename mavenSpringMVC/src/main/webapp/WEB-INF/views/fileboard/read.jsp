	...
	<div align="center">
		<table border="1">
			...
			<c:if test="${boardDto.fileName != null}">
				<tr>
					<td align="center" height="20" width="200">파일명</td>
					<td align="left" height="20" width="200" colspan="3"><a href="${root}/fileboard/downLoad.do?boardNumber=${boardDto.boardNumber}">${boardDto.fileName}</a></td>
				</tr>
			</c:if>
			<tr>
