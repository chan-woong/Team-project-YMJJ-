...
public class BoardDto {
	...
	private int sequenceNumber;					// 글 순서
	...
	public void setDataMap(HashMap<String, String> dataMap) {
		...
		this.boardNumber = Integer.parseInt(dataMap.get("boardNumber"));
		
		if(this.dataMap.get("groupNumber") != null) {
			this.groupNumber = Integer.parseInt(dataMap.get("groupNumber"));
			this.sequenceNumber = Integer.parseInt(dataMap.get("sequenceNumber"));
			this.sequenceLevel = Integer.parseInt(dataMap.get("sequenceLevel"));
		}
		
		this.writer = dataMap.get("writer");
		this.subject = dataMap.get("subject");
		this.email = dataMap.get("email");
		this.content = dataMap.get("content");
