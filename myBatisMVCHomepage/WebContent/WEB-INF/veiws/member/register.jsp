...
<body>
	...
	<div id="register">
		...
		<form id="form_style" action="${root}/member/registerOk.do" method="post" name="memberForm" onsubmit="return registerForm(this)"> <!-- div2 -->
			<div class="line">  <!-- 1행 -->
				<label class="title">아이디</label>  <!-- 1행 1열 -->
				
				<span class="content"> <!--  1행2열-->
					* <input type="text" name="id"/>
					<input type="button" value="아이디 중복" onclick="idCheck(memberForm, '${root}')"/>
				</span>
			</div>
